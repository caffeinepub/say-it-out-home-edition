...
export interface _SERVICE {
  ...
  'getAllApplications' : ActorMethod<[], Array<GuestApplication>>,
  'getAllRSVPs' : ActorMethod<[], Array<RSVP>>,
  'getApplicationById' : ActorMethod<[string], GuestApplication>,
  ...
  'submitApplication' : ActorMethod<[ApplicationInput], string>,
